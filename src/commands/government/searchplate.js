...
module.exports = class searchPlate extends Command {
  ...
  async run ({ t, author, channel, message }, plt) {
    ...
    try {
      ...
      console.log(`https://cdn.jsdelivr.net/gh/bgeneto/bandeiras-br/imagens/${plate.uf}.png`)
      ...
      const oldPlate = await CanvasTemplates.oldPlate(plate.placa.replace(/(....)$/, '-$1'), `${plate.municipio.uf} - ${plate.municipio.toUpperCase()}`)
