...
module.exports = class Switchblade extends Client {
  ...
  addSubcommand (subCommand) {
    ...
    if (parentCommand) {
      ...
      parentCommand = Array.isArray(subCommand.parentCommand) ? subCommand.parentCommand.join(' ') : subCommand.parentCommand
      this.log(`[31m${parentCommand} ${subCommand.name} failed to load - Couldn't find parent command.`, 'Commands')
      return false
    }
